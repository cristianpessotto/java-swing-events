...
public final class Window extends JFrame
{
    ...
    public boolean toggleTheme(KeyEvent e)
    {
        ...
        if (e.getKeyCode() != KeyEvent.VK_SPACE || !e.isControlDown()) return false;
        if (!equals(GlobalKeyboardEventManager.getFocusWindow())) return false;
    ...
    public boolean focusWindow(KeyEvent e)
    {
        if (e.getID() != KeyEvent.KEY_RELEASED) return false;
